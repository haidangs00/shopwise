                ...
                <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                    <div class="product-image">
                        <div class="product_img_box">
                            <img id="product_img" src="{{url('uploads')}}/{{$product->image}}" data-zoom-image="{{url('uploads')}}/{{$product->image}}" alt="product_img1" />
                        ...
                        <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                            ...
                            <div class="item">
                                <a href="#" class="product_gallery_item active" data-image="{{url('uploads')}}/{{$image->path}}" data-zoom-image="{{url('uploads')}}/{{$image->path}}">
                    ...
                    <div class="pr_detail">
                        <div class="product_description">
                            ...
                            <div class="product_price">
                                ...
                                <div class="on_sale">
                                    <span>{{(1 - ($product->promotional_price/$product->regular_price)) *100}}% Off</span>
                                </div>
                            </div>
