                ...
                <div class="col-lg-3 col-md-4">
                    <div class="dashboard_menu">
                        <ul class="nav nav-tabs flex-column" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="address-tab" data-toggle="tab" href="#address" role="tab" aria-controls="address" aria-selected="true"><i class="ti-location-pin"></i>Địa chỉ của tôi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="account-detail-tab" data-toggle="tab" href="#account-detail" role="tab" aria-controls="account-detail" aria-selected="true"><i class="ti-id-badge"></i>Chi tiết tài khoản</a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <form method="post" name="enq">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input class="form-control" name="name" value="{{Auth::guard('web')->user()->name}}" type="text">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Tên đăng nhập <span class="required">*</span></label>
                                                <input class="form-control" name="user_name" value="{{Auth::guard('web')->user()->user_name}}" type="text">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Email <span class="required">*</span></label>
                                                <input class="form-control" name="email" value="{{Auth::guard('web')->user()->email}}" type="email">
                                            </div>
                                            <div class="form-group col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-fill-out" name="submit" value="Submit">Cập nhập</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
