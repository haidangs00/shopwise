                ...
                <div class="col-12">
                    <div class="table-responsive shop_cart_table">
                        <table class="table">
                            ...
                            <form method="post" action="{{route('clients.update_cart')}}">
                                @csrf
                                <tbody>
                                @foreach($cart->items as $item)
                                    <tr>
                                        <td class="product-thumbnail"><a href="#"><img src="{{url('uploads')}}/{{$item['image']}}" alt="{{$item['name']}}"></a></td>
                                        <td class="product-name" data-title="Product"><a href="#">{{$item['name']}}</a></td>
                                        <td class="product-price" data-title="Price">{{$item['price']}}đ</td>
                                        <td class="product-quantity" data-title="Quantity"><div class="quantity">
                                                <input type="button" value="-" class="minus">
                                                <input type="number" name="quantity[{{$item['id']}}]" value="{{$item['quantity']}}" title="Qty" class="qty" size="4">
                                                <input type="button" value="+" class="plus">
                                            </div></td>
                                        <td class="product-subtotal" data-title="Total">{{$item['price']*$item['quantity']}}đ</td>
                                        <td class="product-remove" data-title="Remove"><a href="{{route('clients.delete_cart', $item['id'])}}"><i class="ti-close"></i></a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
                                    ...
                                    <td colspan="6" class="px-0">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-lg-8 col-md-6 text-left text-md-right">
                                                <button class="btn btn-line-fill btn-sm" type="submit">Cập nhập giỏ hàng</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
