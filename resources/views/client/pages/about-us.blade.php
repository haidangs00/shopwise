@extends('client.layouts.master', ['pageTitle' => 'Giới thiệu'])
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about_img scene mb-4 mb-lg-0">
                        <img src="{{url('client')}}/images/about_img.jpg" alt="about_img"/>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="team_box team_style1">
                        <div class="team_img">
                            <img src="{{url('client')}}/images/team_img1.jpg" alt="team_img1">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_box team_style1">
                        <div class="team_img">
                            <img src="{{url('client')}}/images/team_img2.jpg" alt="team_img2">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_box team_style1">
                        <div class="team_img">
                            <img src="{{url('client')}}/images/team_img3.jpg" alt="team_img3">
                            <ul class="social_icons social_style4">
                                <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_box team_style1">
                        <div class="team_img">
                            <img src="{{url('client')}}/images/team_img4.jpg" alt="team_img4">
                            <ul class="social_icons social_style4">
                                <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
                ...
                <div class="col-lg-9">
                    <div class="testimonial_wrap testimonial_style1 carousel_slider owl-carousel owl-theme nav_style2" data-nav="true" data-dots="false" data-center="true" data-loop="true" data-autoplay="true" data-items='1'>
                        <div class="testimonial_box">
                            ...
                            <div class="author_wrap">
                                <div class="author_img">
                                    <img src="{{url('client')}}/images/user_img1.jpg" alt="user_img1" />
                                </div>
                        ...
                        <div class="testimonial_box">
                            ...
                            <div class="author_wrap">
                                <div class="author_img">
                                    <img src="{{url('client')}}/images/user_img2.jpg" alt="user_img2" />
                                </div>
                                <div class="author_name">
                                    <h6>Alden Smith</h6>
                                    <span>Designer</span>
                        ...
                        <div class="testimonial_box">
                            ...
                            <div class="author_wrap">
                                <div class="author_img">
                                    <img src="{{url('client')}}/images/user_img3.jpg" alt="user_img3" />
                                </div>
                                <div class="author_name">
                                    <h6>Daisy Lana</h6>
                                    <span>Designer</span>
                        ...
                        <div class="testimonial_box">
                            ...
                            <div class="author_wrap">
                                <div class="author_img">
                                    <img src="{{url('client')}}/images/user_img4.jpg" alt="user_img4" />
                                </div>
                                <div class="author_name">
                                    <h6>John Becker</h6>
                                    <span>Designer</span>
