...
<head>
    ...
    <link rel="stylesheet" href="client/css/simple-line-icons.css">
    <!--- owl carousel CSS-->
    <link rel="stylesheet" href="client/owlcarousel/css/owl.carousel.min.css">
    <link rel="stylesheet" href="client/owlcarousel/css/owl.theme.css">
    <link rel="stylesheet" href="client/owlcarousel/css/owl.theme.default.min.css">
    <!-- Magnific Popup CSS -->
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        <div class="lng_dropdown mr-2">
                            <select name="countries" class="custome_select">
                                <option value='en' data-image="client/images/eng.png" data-title="English">English</option>
                                <option value='fn' data-image="client/images/vn.png" data-title="France">Vietnam</option>
                            </select>
                        </div>
                        <div class="mr-3">
                            <select name="countries" class="custome_select">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="index.html">
                    <img class="logo_light" src="client/images/logo_light.png" alt="logo" />
                    <img class="logo_dark" src="client/images/logo_dark.png" alt="logo" />
                </a>
                                ...
                                <div class="d-lg-flex menu_banners">
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="client/images/menu_banner1.jpg" alt="menu_banner1">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="client/images/menu_banner2.jpg" alt="menu_banner2">
                                            <div class="banne_info">
                                                <h6>15% Off</h6>
                                                <h4>Men's Fashion</h4>
                                                <a href="#">Shop now</a>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="client/images/menu_banner3.jpg" alt="menu_banner3">
                                            <div class="banne_info">
                                                <h6>23% Off</h6>
                                                <h4>Kids Fashion</h4>
                                                <a href="#">Shop now</a>
                                            ...
                                            <div class="header_banner_content">
                                                <div class="shop_banner">
                                                    <div class="banner_img overlay_bg_40">
                                                        <img src="client/images/shop_banner.jpg" alt="shop_banner"/>
                                                    </div>
                        ...
                        <div class="cart_box dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    ...
                                    <a href="#"><img src="client/images/cart_thamb1.jpg" alt="cart_thumb1">Variable product 001</a>
                                    <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>78.00</span>
                                </li>
                                <li>
                                    <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="#"><img src="client/images/cart_thamb2.jpg" alt="cart_thumb2">Ornare sed consequat</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="footer_logo">
                            <a href="#"><img src="client/images/logo_light.png" alt="logo"/></a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="footer_payment text-center text-lg-right">
                        <li><a href="#"><img src="client/images/visa.png" alt="visa"></a></li>
                        <li><a href="#"><img src="client/images/discover.png" alt="discover"></a></li>
                        <li><a href="#"><img src="client/images/master_card.png" alt="master_card"></a></li>
                        <li><a href="#"><img src="client/images/paypal.png" alt="paypal"></a></li>
                        <li><a href="#"><img src="client/images/amarican_express.png" alt="amarican_express"></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<!-- owl-carousel min js  -->
<script src="client/owlcarousel/js/owl.carousel.min.js"></script>
...
<!-- elevatezoom js -->
<script src="client/js/jquery.elevatezoom.js"></script>
<!-- scripts js -->
