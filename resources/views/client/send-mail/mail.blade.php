                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                                            ...
                                                                                            <img class="max-width"
                                                                                                 ...
                                                                                                 src="https://bestwebcreator.com/shopwise/assets/images/logo_dark.png"
                                                                                                 height="33">
                                                                                        </td>
                                                                                    </tr>
                                                                                    </tbody>
                                                                                        ...
                                                                                        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="font-size: 43px">Cảm ơn đơn đặt hàng của bạn, {{$user_name}}!&nbsp;</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                        ...
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="font-size: 18px">Đơn hàng của bạn đã đặt thành công!</span><span
                                                                                                        style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> Sản phẩm đã săn sàng được giao</span><span
                                                                                                        style="font-size: 18px">.</span>
                                                                                                </div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #FF324D; font-size: 18px"><strong>Thank you!&nbsp;</strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                            ...
                                                                                            <table border="0"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        <a href=""
                                                                                                           style="background-color:#FF324D; border:1px solid #FF324D; border-color:#FF324D; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                                                                           target="_blank">Shopwise now</a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:50px 30px 50px 30px; line-height:22px; text-align:inherit; background-color:#6e6e6e;"
                                                                                            height="100%" valign="top"
                                                                                            bgcolor="#6e6e6e"
                                                                                            role="module-content">
                                                                                            <div>
                                                                                                ...
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px">1. Upload your resume &nbsp;and we'll keep it on file for every job submission.</span>
                                                                                                </div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <br></div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px">2. Submit and edit personalized cover letters for every job you apply to.</span>
                                                                                                </div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <br></div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px">3. Get access to our career coaches when you need 1:1 help with your job application.</span>
                                                                                                </div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #FF324D; font-size: 18px"><strong>+ much more!</strong></span>
                                                                                                </div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <br></div>
                                                                                            ...
                                                                                            <table border="0"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        <a href=""
                                                                                                           style="background-color:#FF324D; border:1px solid #FF324D; border-color:#FF324D; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                                                                           target="_blank">Liên hệ hỗ trợ</a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
