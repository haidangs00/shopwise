@extends('admin.layouts.master', ['pageTitle'=>'Cập nhập bài viết'])
                        ...
                        <div class="col-lg-12">
                            <div class="modal-content">
                                <div class="modal-header form-header">
                                    <h5 class="modal-title form-title">Cập nhập bài viết</h5>
                                </div>
                                <div class="modal-body pd">
                                    <form class="form-action" method="post" action="{{route('blogs.update', $blog->id)}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <img id="img-show" src="{{url('uploads')}}/{{$blog->image}}" alt="{{$blog->title}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="status">Trạng thái:</label>
                                            <div class="radio">
                                                <input id="radio-1" name="status" type="radio" value="1" {{$blog->status=='1'?'checked':''}}>
                                                <label for="radio-1" class="radio-label">Active</label>
                                            </div>
                                            <div class="radio">
                                                <input id="radio-2" name="status" type="radio" value="0" {{$blog->status=='0'?'checked':''}}>
