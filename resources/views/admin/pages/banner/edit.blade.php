@extends('admin.layouts.master', ['pageTitle'=>'Cập nhập banner'])
                        ...
                        <div class="col-lg-12">
                            <div class="modal-content">
                                <div class="modal-header form-header">
                                    <h5 class="modal-title form-title">Cập nhập banner</h5>
                                </div>
                                <div class="modal-body pd">
                                    <form class="form-action" method="post" action="{{route('banners.update', $banner->id)}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" value="{{$banner->slug}}" class="form-control" placeholder="Nhập slug">
                                        </div>
                                        <div class="form-group">
                                            <label for="note">Mô tả:</label>
                                            <input type="text" name="note" value="{{$banner->note}}" class="form-control" placeholder="Nhập mô tả">
                                        </div>
                                        <div class="form-group">
                                            <label for="slug">Ảnh banner:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <input id="radio-1" name="status" type="radio" value="1" {{$banner->status=='1'?'checked':''}}>
                                                <label for="radio-1" class="radio-label">Active</label>
                                            </div>
                                            <div class="radio">
                                                <input id="radio-2" name="status" type="radio" value="0" {{$banner->status=='0'?'checked':''}}>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:90%">
                <div class="modal-content" style="height: 700px">
                    ...
                    <div class="modal-body">
                        <iframe class="modal-file w-100 h-100" src="{{url('filemanager')}}/dialog.php?field_id=file"></iframe>
                    </div>
