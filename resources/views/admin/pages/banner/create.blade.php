                                    ...
                                    <form class="form-action" method="post" action="{{route('banners.store')}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input_wrap common_date_picker mb_20">
                                                <input name="date_begin" class="input_form" id="start_datepicker" placeholder="Ngày bắt đầu">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="status">Ngày kết thúc:</label>
                                            <div class="input_wrap common_date_picker mb_20">
                                                <input name="date_end" class="input_form" id="end_datepicker" placeholder="Ngày kết thúc">
                                            </div>
                                        </div>
