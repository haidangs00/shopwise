@extends('admin.layouts.master', ['pageTitle'=>'Thêm mới banner'])
                        ...
                        <div class="col-lg-12">
                            <div class="modal-content">
                                <div class="modal-header form-header">
                                    <h5 class="modal-title form-title">Thêm mới banner</h5>
                                </div>
                                <div class="modal-body pd">
                                    <form class="form-action" method="post" action="{{route('banners.store')}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="note" class="form-control" placeholder="Nhập mô tả">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input_wrap common_date_picker mb_20">
                                                <input autocomplete="off" name="date_begin" class="input_form" id="start_datepicker" placeholder="Ngày bắt đầu">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="status">Ngày kết thúc:</label>
                                            <div class="input_wrap common_date_picker mb_20">
                                                <input autocomplete="off" name="date_end" class="input_form" id="end_datepicker" placeholder="Ngày kết thúc">
                                            </div>
                                        </div>
