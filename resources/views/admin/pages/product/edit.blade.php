                        ...
                        <div class="col-lg-12">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pd">
                                    <form class="form-action" method="post" action="{{route('products.update', $product->id)}}"
                                            ...
                                            <div class="row" id="img-show-list">
                                                @foreach($images as $image)
                                                    <div class="col-md-3 img-thumbnail">
                                                        <img class="img-fluid" src="{{url('uploads')}}/{{$image->path}}" alt="">
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <input id="radio-1" name="status" type="radio" value="1" {{$product->status=='1'?'checked':''}}>
                                                <label for="radio-1" class="radio-label">Active</label>
                                            </div>
                                            <div class="radio">
                                                <input id="radio-2" name="status" type="radio" value="0" {{$product->status=='0'?'checked':''}}>
                                                ...
                                                @foreach($colors as $color)
                                                    <label class="form-checkbox-label">
                                                        <input name=colors[] value="{{$color->id}}" class="form-checkbox-field"
                                                               type="checkbox" {{in_array($color->id, $product_colors)?'checked':''}}/>
                                                ...
                                                @foreach($sizes as $size)
                                                    <label class="form-checkbox-label">
                                                        <input name=sizes[] value="{{$size->id}}" class="form-checkbox-field"
                                                               type="checkbox" {{in_array($size->id, $product_sizes)?'checked':''}}/>
